...
```{r setup}
librarian::shelf(
  DBI, dplyr, DT, duckdb, fs, glue, here, htmltools, stringr,
  quiet = T)
...
showtable <- function(data, filename = "table", escape = F, rownames = F) {
...
# TODO: get all common names in a seperate table and look up match across any
